...
var addToSocketViewer_1 = require("./eventsub/addToSocketViewer");
var SocketManager = /** @class */ (function () {
    ...
    SocketManager.prototype.connectToEvents = function () {
        return __awaiter(this, void 0, void 0, function () {
            var props, addSocketViewerClass;
            return __generator(this, function (_a) {
                props = { token: this.token, userId: this.userId, clientId: this.clientId, sessionId: this.sessionId };
                addSocketViewerClass = new addToSocketViewer_1.AddToSocketViewer(props);
